...
public class SerumCalciumController implements Connection{
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        SubmitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                labReport.setFreeCalcium(FreeCalciumTextField.getText());
                labReport.setTotalCalcium(TotalCalciumTextField.getText());
